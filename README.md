...
[deepwiki](https://deepwiki.com/attila-lendvai/maru/) is also not
useless.
...
A list of projects that are relevant in this context:
  ...
  - [Loko Scheme](https://scheme.fail/) is a self-hosting scheme that
    runs on the bare metal, i.e. some hardware drivers included.
  ...
  - [sectorlisp](https://justine.lol/sectorlisp2/)
    ...
    implementation (in the form of a boot sector), and John McCarthy's
